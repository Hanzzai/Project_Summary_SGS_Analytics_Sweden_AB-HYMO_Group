...
map.getView().fit([272316.950810, 6490840.776401, 742096.156436, 6787583.376401], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Projektsammanställning SGS Analytics Sweden AB - Hymogruppen</h2>';
        return titleElement;
    })(),
